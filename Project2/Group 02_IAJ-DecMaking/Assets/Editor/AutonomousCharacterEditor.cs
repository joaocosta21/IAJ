...
public class AutonomousCharacterEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        SerializedProperty worldType = serializedObject.FindProperty("worldModelType");
        ...
        EditorGUILayout.PropertyField(worldType, new GUIContent("World Model Type"));
            ...
            character.characterControl == AutonomousCharacter.CharacterControlType.GOAP)
        {
            ...
            character.characterControl == AutonomousCharacter.CharacterControlType.MCTS_LimitedPlayout)
        {
            EditorGUILayout.Space(); 
