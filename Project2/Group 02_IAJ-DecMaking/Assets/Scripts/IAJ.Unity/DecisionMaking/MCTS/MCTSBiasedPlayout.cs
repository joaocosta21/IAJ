    ...
    public class MCTSBiasedPlayout
    {
        ...
        protected virtual float Playout(WorldModel state)
        {
            ...
            while (!currentState.IsTerminal())
            {
                ...
                // Replace anonymous type with Tuple<Action, float>
                var actionHeuristicValues = actions.Select(action => 
            ...
            return currentState.GetScore(); // Return reward for the final state
        }
